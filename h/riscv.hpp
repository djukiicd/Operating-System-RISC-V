...
//ako imamo poziv u ra reg ce biti upisana adresa na koju prog treba da se vrati (sa inline nema tog upisa)
class Riscv
{
public:
...
private:
    ...
    //handle za sistemske pzoive
    static void handleSyscall();

    //handle za prekide od tajmera
    static void handleTimerInterrupt();

    //handle za prekide od konzozle
    static void handleConsoleInterrupt();

    //handle za bad cause
    static void handleBadCause();
};
